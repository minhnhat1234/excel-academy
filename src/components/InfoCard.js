        ...
        <Card>
            ...
            <CardContent>
                ...
                <Typography variant = {type == 'featured'? 'body1' : 'body2'} paragraph>
                    Suspendisse sollicitudin porta dictum. Integer ac fermentum dolor. Nunc at posuere nisi, vel interdum sem. Etiam nisl purus, laoreet sit.
                </Typography>
            </CardContent>
            <CardActions>
                <Button className={classes.cardButtons} variant = 'contained' color='secondary'>Learn More</Button>
            </CardActions>
        </Card>
    )
}